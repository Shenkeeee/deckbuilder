...
if __name__ == "__main__":
    input_folder = r"C:\Users\ASUS\Downloads\2024Lapok\2024"  # Folder to search for .jpg files
    output_folder = r"C:\Users\ASUS\Downloads\2024Lapok\2024-fixed2"  # Folder to save renamed files
    ...
    border_range = (0, 0)  # Specify the border range (inclusive)
